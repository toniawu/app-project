<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="hospitalImg"  label-width="100" label="图片文件">
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("name,pos_x,pos_y,descInfo,hospitalImg").get().then((res) => {
