...
<script>
  import { validator } from '../../js_sdk/validator/Options4.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'Options4';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("surveys_id,question_id,num,serial,content,state").get().then((res) => {
