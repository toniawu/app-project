...
<script>
  import { validator } from '../../js_sdk/validator/Surveys.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'Surveys';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("num,title,description,category_id").get().then((res) => {
